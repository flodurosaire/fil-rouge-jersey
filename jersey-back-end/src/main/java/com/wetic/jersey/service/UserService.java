...
import com.wetic.jersey.security.AuthoritiesConstants;
import com.wetic.jersey.security.SecurityUtils;
import com.wetic.jersey.service.dto.UserDTO;
import com.wetic.jersey.service.util.RandomUtil;
import com.wetic.jersey.web.rest.errors.*;
import com.wetic.jersey.service.dto.RecetteChartOutput;
import com.wetic.jersey.service.dto.StatsDTO;
...
public class UserService {
    ...
    public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder,
            AuthorityRepository authorityRepository, DepenseRepository depenseRepository,
            ProduitRepository produitRepository, FactureRepository factureRepository, ClientRepository clientRepository) {
    ...
    public Optional<User> getUserWithAuthorities() {
        Optional<User> result = SecurityUtils.getCurrentUserLogin()
    ...
    public StatsDTO getStats() {
        ...
        stats.setCountClient(clientRepository.count());
        stats.setCountFacture(factureRepository.count());
        stats.setCountProduit(produitRepository.count());
        stats.setSumDepense(depenseRepository.SumAll());
        return stats;
    }

    // AI NOTE: groupe the needed data for the chart -> recetteChart
    public RecetteChartOutput getRecetteChartData() {
    	RecetteChartOutput recetteChartOutput = new RecetteChartOutput();
    	recetteChartOutput.setSumDepensesByMonth(depenseRepository.SumDepensesByMonth());
    	recetteChartOutput.setSumFacturesByMonth(factureRepository.SumFacturesByMonth());
    	recetteChartOutput.setCLientAddedByMonth(clientRepository.CLientAddedByMonth());
    	return recetteChartOutput;
    }
