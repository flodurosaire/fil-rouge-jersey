...
import com.wetic.jersey.service.dto.PasswordChangeDTO;
import com.wetic.jersey.service.dto.UserDTO;
import com.wetic.jersey.web.rest.errors.*;
import com.wetic.jersey.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    public ResponseEntity<UserDTO> registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        return ResponseUtil.wrapOrNotFound(
                userService.getUserWithAuthorities(user.getId())
                    .map(UserDTO::new));
    }
    ...
    public UserDTO getAccount() {
        UserDTO result = userService.getUserWithAuthorities()
            .map(UserDTO::new)
