...
/**
 * REST controller for managing {@link com.wetic.jersey.domain.Produit}.
 */
@RestController
@RequestMapping("/api")
public class ProduitResource {
     ...
     */
    @GetMapping("/produits")
    public ResponseEntity<List<ProduitDTO>> getAllProduits(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
