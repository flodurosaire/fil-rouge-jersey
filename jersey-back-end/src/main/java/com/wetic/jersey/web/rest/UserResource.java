...
import com.wetic.jersey.web.rest.errors.EmailAlreadyUsedException;
import com.wetic.jersey.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    // AI note: this get the data needed for statistiques cards -> dashboard
    @GetMapping("/users/user/stats")
    ...
    //AI note: 
    @GetMapping("/users/dashboard/recettechart")
    public ResponseEntity<RecetteChartOutput> getRecetteChartData() {
        log.debug("REST request to get statistiques for dashboard admin");
        return ResponseEntity.ok(userService.getRecetteChartData());
    }
